...
public class DES {
	static final String Dir = "output/DES";
	...
	static {
		try {
			...
			String keyFilePath = Dir + "/desKey.txt";
			...
			System.out.println("\nDES data encryption done Successfully!");

			long executionTime = endTime - startTime;
			System.out.println("DES Encryption Time: " + executionTime + " ns");

			try (PrintWriter out = new PrintWriter(new FileWriter(timeTxt, true))) {
				out.println("DES	" + executionTime + " ns");
			} catch (IOException e) {
				e.printStackTrace();
			}
			...
			System.out.println("DES data decryption done Successfully!");
