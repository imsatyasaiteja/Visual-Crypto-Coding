...
public class AES {
    static final String Dir = "output/AES";
    ...
    static {
        try {
            ...
            String keyFilePath = Dir + "/aesKey.txt";
            ...
            System.out.println("\nAES data encryption done Successfully!");

            long executionTime = endTime - startTime;
            System.out.println("AES Encryption Time: " + executionTime + " ns");

            try (PrintWriter out = new PrintWriter(new FileWriter(timeTxt, true))) {
                out.println("AES	" + executionTime + " ns");
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            System.out.println("AES data decryption done Successfully!");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
